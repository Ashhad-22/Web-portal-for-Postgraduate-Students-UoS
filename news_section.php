  ...
  <div id="min-height" class="container-fluid" padding="20px">
    <div class='card'>
        ...
        <div class="card-header">
          <h2 style="padding-top:10px; text-align:center; ">Add News </h2>
        </div><br>
          <div class="form-group">
              <label for="title">Title</label><br>
              <textarea name="title" cols="5" rows="5" style="border: 1px solid;"></textarea><br>

              <label for="desc">Description</label>
              <textarea name="description" rows="10" cols="10" style="border: 1px solid;"></textarea><br>
