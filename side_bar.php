...
<div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="#" style="color:white; margin-right:65px;"><img class="main-logo"  src="<?=base_url()?>dash_assets/img/logo/test.png" width='40px' height='30px' alt=""/>PGCICT</a>
                <strong><a href="#"><img src="<?=base_url()?>dash_assets/img/logo/test.png" alt="" width='40px' height='30px' /></a></strong>
            </div>
