...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  ...
  <footer class="footer" data-background-color="black">
    <div class="container-fluid" style="background:linear-gradient(60deg,#5162b0,#5162b0); color:white; margin-bottom:-14px;">
      ...
      <div class="copyright float-right ">
        ...
        <b> &copy; 2022,  Dr A.H.S Bukhari Post Graduate Center for ICT, University of Sindh, Jamshoro</b>
      </div>
    </div>
  </footer>
